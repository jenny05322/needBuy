...
function renderCards() {
  ...
  document.getElementById('statsText').textContent = `共 ${filtered.length} / ${records.length} 間`;
...
function openAddModal() {
  ...
  ['fName', 'fCity', 'fAddress', 'fUrl', 'fNote', 'fImgUrl']
