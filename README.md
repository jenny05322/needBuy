...
記錄旅途中購買的好物與收藏的商店，資料儲存於 Google Sheets。

## 功能

### 物品使用心得
- 新增、編輯、刪除購物記錄
- 欄位：物品名稱、品牌、分類、國家、購買點、幣別、價格、評分、圖片、使用心得
- 依國家、評分篩選，全文搜尋
- 分類以 badge 顯示於卡片左上角

### 商店口袋名單
- 記錄旅途中收藏的商店
- 欄位：商店名稱、類型、國家、城市、地址、地圖連結、評分、備註、圖片
- 依類型、國家篩選，全文搜尋
- 類型以 badge 顯示於卡片左上角
...
- 圖示使用 Heroicons v2 Outline，定義於 `icons.js`
